...
async function generateOg(cabin) {
  ...
  // Logo scale: original SVG is 78×18, render at 3× = 234×54
  const LOGO_SCALE = 3;
  const LOGO_X = 48;
  const LOGO_Y = 48;
  ...
  const textSvg = Buffer.from(`
    <svg width="${OG_WIDTH}" height="${OG_HEIGHT}" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(${LOGO_X}, ${LOGO_Y}) scale(${LOGO_SCALE})">
        ...
        <path d="M7.92675 0C9.97158 0 11.511 0.457909 13.1652 1.57963C10.1366 5.16654 10.1242 10.4113 13.1359 14.0124L13.2744 14.178C11.5053 15.4143 9.60402 15.9336 7.5362 15.842C3.0329 15.636 3.89762e-06 12.3852 0 7.78373C0 3.38826 3.44643 0 7.92675 0Z" fill="url(#logoGrad)"/>
        <defs>
          <linearGradient id="logoGrad" x1="6.63721" y1="0" x2="6.63721" y2="15.8523" gradientUnits="userSpaceOnUse">
            <stop stop-color="#34D399"/>
            <stop offset="0.634615" stop-color="#3B82F6"/>

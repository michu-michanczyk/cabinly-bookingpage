...
export function CabinlyFooter() {
  return (
    <div className="w-full bg-bg-surface-secondary dark:bg-white dark:border-t dark:border-[#e5e5e5]">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 pt-12 pb-28 md:pb-12 flex flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div className="flex flex-col text-xs leading-tight">
            ...
            <span className="text-white/60 dark:text-[#010101]/60">Turn empty nights into<br className="sm:hidden" /> direct bookings</span>
          </div>
        </div>
